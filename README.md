...
- **[Business Rules & Philosophy](docs/BUSINESS_RULES.md)**: Explains the Flowmodoro method, state machine logic, psychology-first design principles, and cognitive limits of deep work.
- **[Technical Documentation](docs/TECHNICAL_DOCS.md)**: Details the technology stack, project structure, component architecture, and the `useFlowmodoro` composable API.
